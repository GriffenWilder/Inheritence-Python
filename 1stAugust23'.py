...
print("Dog",dog.speak())
print("Dog",dog.move())"""
#Create a class BankAccount with attributes like account_number, account_holder_name, and balance.
#Implement child classes SavingsAccount and CheckingAccount, which inherit from BankAccount. 
#Add specific methods like calculate_interest for the SavingsAccount class
#and deduct_fees for the CheckingAccount class.
"""
class BankAccount:
